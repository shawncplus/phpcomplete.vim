...
Once you have your shiny new ctags, when generating your tags files use the following `-field` option `-fields=+aimS`, so your tag files will have more information. For example, in your project's root:
```
